...
def update_all_frames(cap, frame1, frame2, frame3, frame4, log_func, distance_label=None):
    ret, frame = cap.read()
    if not ret:
    ...
    if ret:
        ...
        processed_frame3 = process_frame_with_masked_lines(frame.copy(), log_func)
    ...
    frame1.after(10, update_all_frames, cap, frame1, frame2, frame3, frame4, log_func, distance_label)
